/*
** Lua binding: zeus
** Generated automatically by tolua++-1.0.92 on 07/11/17 22:12:33.
*/
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"VisualInfoT");
}
...
static int tolua_zeus_CVisionModule_SetNewVision00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"CVisionModule",0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"const VisualInfoT",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  CVisionModule* self = (CVisionModule*)  tolua_tousertype(tolua_S,1,0);
  const VisualInfoT* vInfo = ((const VisualInfoT*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
...
static int tolua_zeus_CWorldModel_isMarkingFrontValid00(lua_State* tolua_S)
{
 ...
 {
  CWorldModel* self = (CWorldModel*)  tolua_tousertype(tolua_S,1,0);
  CGeoPoint tolua_var_17 = *((CGeoPoint*)  tolua_tousertype(tolua_S,2,0));
  double tolua_var_18 = ((double)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'isMarkingFrontValid'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->isMarkingFrontValid(tolua_var_17,tolua_var_18);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
static int tolua_zeus_Munkres_solve00(lua_State* tolua_S)
{
 ...
 {
  Munkres* self = (Munkres*)  tolua_tousertype(tolua_S,1,0);
  Matrix<double>* tolua_var_19 = ((Matrix<double>*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'solve'", NULL);
#endif
  {
   self->solve(*tolua_var_19);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE

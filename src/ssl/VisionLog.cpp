...
void VisionLog::writeLog(FILE *fp,VisualInfoT msg)
{
	int i = 0;
...
void VisionLog::createFile(void)
{
	...
	CString str = ".\\LOG\\ssl\\"+strtime+".log";
	CString strRct = ".\\LOG\\ssl\\Recent"+strtime+".log";
	CString strBallTrack = ".\\LOG\\ssl\\BallTrack" + strtime + ".txt";
...
void VisionLog::addRecentLog(VisualInfoT msg)
{

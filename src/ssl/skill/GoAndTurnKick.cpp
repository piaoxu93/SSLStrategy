...
namespace
{
	...
	//Set Configs
	static double CHASE_RANGE = 100.0;			//追球范围
	...
	static double ROUND_RANGE = 5.0 + Param::Vehicle::V2::PLAYER_SIZE + Param::Field::BALL_SIZE;			//GOTO圆弧半径
	static double AVOID_RANGE = 10.0 + Param::Vehicle::V2::PLAYER_SIZE + Param::Field::BALL_SIZE;
	...
	static double AIM_PRECISION = 3.0 * degree;	//AIM精度

	static double KICK_ABANDON_RANGE = 5.0 + Param::Vehicle::V2::PLAYER_SIZE + Param::Field::BALL_SIZE;		//KICK放弃范围_距离
	static double KICK_ABANDON_PRECISION = 5.0 * degree; //KICK放弃范围_角度
